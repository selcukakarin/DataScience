...
# rf_reg.predict(X) = X değerinden Y'yi tahmin eder
...
# HANDİKAP = decision treenin dezavantajı training değerini mükemmel tahmin etmesine karsı 
# farklı bir değer verildiğinde yuvarlama yapıyor gibi davranması
...
# R2 degeri hesaplama
from sklearn.metrics import r2_score
# r_dt.predict(X) = X değerinden Y'yi tahmin eder
