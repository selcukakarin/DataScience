...
veriOnisleme=dataset.iloc[:,[0,1,4,5,2]].values   # işlem yapılacak kolonları aldık. (hasta yaşı, BI-RADS sonucu,Kitle yoğunluğu, akraba tarihi,kanser sonucu)
eksikVeri=pd.DataFrame(data=veriOnisleme, columns=["Hasta_yas","BI-RADS_sonuc","Kitle_yogunlugu","Akraba_tarih","Kanser_Sonucu"])  
